    ...
    return (
        <PageContainer title="About InnoSprint 2.0">
            <div className="space-y-6 text-lg">
              <p>InnoSprint 2.0 is not just a hackathon; it's a 24-hour battleground for the brightest minds in technology to forge new creations, challenge their limits, and rise as champions of innovation. Inspired by the relentless spirit of ancient warriors, we challenge you to build solutions that are powerful, resilient, and legendary.</p>
