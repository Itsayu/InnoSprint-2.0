...
export function LogoCard({ name, logoUrl, dataAiHint }: LogoCardProps) {
  return (
    <Card className="bg-card/50 backdrop-blur-lg hover:bg-card/80 transition-all duration-300 ease-in-out group border-border/50 hover:shadow-primary/20 hover:shadow-lg hover:-translate-y-1">
